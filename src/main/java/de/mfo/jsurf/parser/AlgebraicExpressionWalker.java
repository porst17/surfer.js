...
{
    public static final String[] tokenNames = new String[] { "<invalid>", "<EOR>", "<DOWN>", "<UP>", "PLUS", "MINUS", "MULT", "DIV", "POW", "LPAR", "RPAR", "IDENTIFIER", "DECIMAL_LITERAL", "FLOATING_POINT_LITERAL", "DIGIT", "EXPONENT", "LETTER", "WHITESPACE" };
    ...
    {
	return AlgebraicExpressionWalker.tokenNames;
    }

    public String getGrammarFileName()
    {
	return "AlgebraicExpressionWalker.g";
    }
	...
	try
	{
		...
		// AlgebraicExpressionWalker.g:174:11: pe= primary_expr
		{
		    ...
		    retval.op = (pe != null ? pe.op : null);
		    retval.decimal = pe.decimal;
	...
	try
	{
		...
		// AlgebraicExpressionWalker.g:178:4: i= DECIMAL_LITERAL
		{
		    ...
		    retval.op = new DoubleValue(createDouble((i != null ? i.getText() : null)));
		    retval.decimal = Integer.valueOf(createInteger((i != null ? i.getText() : null)));
